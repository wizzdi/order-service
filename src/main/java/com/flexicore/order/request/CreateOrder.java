...
public class CreateOrder {
	...
	public <T extends CreateOrder> T setConsumingOrganizationId(
			String consumingOrganizationId) {
	...
	public <T extends CreateOrder> T setConsumingOrganization(
			Organization consumingOrganization) {
	...
	public <T extends CreateOrder> T setOrderSentDate(
			OffsetDateTime orderSentDate) {
