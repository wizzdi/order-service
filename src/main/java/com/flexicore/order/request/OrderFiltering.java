...
public class OrderFiltering extends FilteringInformationHolder {
    ...
    public <T extends OrderFiltering> T setConsumingOrganizationIds(Set<String> consumingOrganizationIds) {
    ...
    public <T extends OrderFiltering> T setConsumingOrganizations(List<Organization> consumingOrganizations) {
