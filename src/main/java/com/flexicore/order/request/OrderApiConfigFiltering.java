...
public class OrderApiConfigFiltering extends FilteringInformationHolder {
	...
	public <T extends OrderApiConfigFiltering> T setSupplierIds(
	...
	public <T extends OrderApiConfigFiltering> T setOrderApiConfigIds(
			Set<String> orderApiConfigIds) {
	...
	public <T extends OrderApiConfigFiltering> T setSuppliers(
	...
	public <T extends OrderApiConfigFiltering> T setOrderApiConfigs(
			Set<OrderApiConfig> orderApiConfigs) {
